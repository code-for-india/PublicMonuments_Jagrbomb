...
public class BeaconIntentProcessor extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (rangingData != null) {
            ...
            BeaconManager.logDebug(TAG, "111111111111111111111");
			...
			if (notifier != null) {
                ...
                BeaconManager.logDebug(TAG, "22222222222222222222");
            ...
            if (dataNotifier != null) {
                ...
                BeaconManager.logDebug(TAG, "33333333333333333");

            }

		}
		if (monitoringData != null) {
            BeaconManager.logDebug(TAG, "44444444444444444444");
