...
public class BeaconManager {
     ...
     */
    public static final long DEFAULT_FOREGROUND_BETWEEN_SCAN_PERIOD = 1000;     // 3 milliseconds in foreground
    /**
    ...
    public static final long DEFAULT_BACKGROUND_BETWEEN_SCAN_PERIOD = 2000;    // 2 milliseconds in background
