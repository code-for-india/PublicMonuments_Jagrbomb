...
public class BeaconTransmitter {
    ...
    public BeaconTransmitter(Context context, BeaconParser parser) {
        ...
        if (bluetoothManager != null) {
            ...
            Log.d("onCreate", "111111111111111111111");
            if (mBluetoothAdapter == null) Log.e("onCreate", "mBluetoothAdapter is NULL!!!!!");
            Log.d("onCreate", "22222222222222222");
            ...
            Log.d("onCreate", "33333333333333333333");

           /* mBluetoothLeAdvertiser = mBluetoothAdapter.getBluetoothLeAdvertiser();
            Log.d(TAG,mBluetoothAdapter.getBluetoothLeAdvertiser()+"**");
    ...
    public void startAdvertising() {
        ...
        mBluetoothLeAdvertiser = (BluetoothLeAdvertiser)((BluetoothAdapter)((BluetoothManager)mContext.getSystemService(Context.BLUETOOTH_SERVICE)).getAdapter()).getBluetoothLeAdvertiser();
        if (mBluetoothLeAdvertiser == null)
        {
            Log.d("startAdvertising", "didn't get a bluetooth le advertiser");
            return;
        }
        else
        {
            Log.d("startAdvertising", "got a bluetooth le advertiser");
        }
